...
const (
	...
	ChannelJoin_Type_TYPE_UNSPECIFIED ChannelJoin_Type = 0
	// A room which anyone can join to chat.
	ChannelJoin_Type_ROOM ChannelJoin_Type = 1
	// A private channel for 1-on-1 chat.
	ChannelJoin_Type_DIRECT_MESSAGE ChannelJoin_Type = 2
	// A channel for group chat.
	ChannelJoin_Type_GROUP ChannelJoin_Type = 3
)
...
type ChannelJoin struct {
	...
	Type int32 `protobuf:"varint,2,opt,name=type,proto3" json:"type,omitempty"` // one of "ChannelJoin_Type".
...
type Error struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The error code which should be one of "Error_Code" enums.
...
const file_realtime_proto_rawDesc = "" +
	...
	"\vuser_id_two\x18\a \x01(\tR\tuserIdTwo\"\xab\x01\n" +
	...
	"\x06hidden\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x06hidden\"-\n" +
	...
	"\bgroup_id\x18\x05 \x01(\tR\agroupId\x12\x1e\n" +
	"\vuser_id_one\x18\x06 \x01(\tR\tuserIdOne\x12\x1e\n" +
	"\vuser_id_two\x18\a \x01(\tR\tuserIdTwo\"\xb0\x01\n" +
	"\x05Error\x12\x12\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xf2\x03\n" +
	" MatchmakerMatched_MatchmakerUser\x129\n" +
	"\bpresence\x18\x01 \x01(\v2\x1d.nakama.realtime.UserPresenceR\bpresence\x12\x19\n" +
	"\bparty_id\x18\x02 \x01(\tR\apartyId\x12t\n" +
	"\x11string_properties\x18\x05 \x03(\v2G.nakama.realtime.MatchmakerMatched_MatchmakerUser.StringPropertiesEntryR\x10stringProperties\x12w\n" +
	"\x12numeric_properties\x18\x06 \x03(\v2H.nakama.realtime.MatchmakerMatched_MatchmakerUser.NumericPropertiesEntryR\x11numericProperties\x1aC\n" +
	"\x15StringPropertiesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aD\n" +
	"\x16NumericPropertiesEntry\x12\x10\n" +
	...
	"\x05users\x18\x04 \x03(\v21.nakama.realtime.MatchmakerMatched_MatchmakerUserR\x05users\x12E\n" +
	"\x04self\x18\x05 \x01(\v21.nakama.realtime.MatchmakerMatched_MatchmakerUserR\x04selfB\x04\n" +
	"\x02id\"*\n" +
	...
	"\x06status\x18\x05 \x01(\v2\x1c.google.protobuf.StringValueR\x06status*Q\n" +
	"\x10ChannelJoin_Type\x12\x14\n" +
	"\x10TYPE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04ROOM\x10\x01\x12\x12\n" +
	"\x0eDIRECT_MESSAGE\x10\x02\x12\t\n" +
	"\x05GROUP\x10\x03*\xcf\x01\n" +
	"\n" +
	"Error_Code\x12\x15\n" +
	...
	"\x1aRUNTIME_FUNCTION_EXCEPTION\x10\aBl\n" +
...
var file_realtime_proto_goTypes = []any{
	(ChannelJoin_Type)(0),                    // 0: nakama.realtime.ChannelJoin_Type
	(Error_Code)(0),                          // 1: nakama.realtime.Error_Code
	...
	(*MatchmakerMatched_MatchmakerUser)(nil), // 20: nakama.realtime.MatchmakerMatched_MatchmakerUser
	...
	(*PartyUpdate)(nil),                      // 27: nakama.realtime.PartyUpdate
	(*PartyJoin)(nil),                        // 28: nakama.realtime.PartyJoin
	(*PartyLeave)(nil),                       // 29: nakama.realtime.PartyLeave
	(*PartyPromote)(nil),                     // 30: nakama.realtime.PartyPromote
	(*PartyLeader)(nil),                      // 31: nakama.realtime.PartyLeader
	(*PartyAccept)(nil),                      // 32: nakama.realtime.PartyAccept
	(*PartyRemove)(nil),                      // 33: nakama.realtime.PartyRemove
	(*PartyClose)(nil),                       // 34: nakama.realtime.PartyClose
	(*PartyJoinRequestList)(nil),             // 35: nakama.realtime.PartyJoinRequestList
	(*PartyJoinRequest)(nil),                 // 36: nakama.realtime.PartyJoinRequest
	(*PartyMatchmakerAdd)(nil),               // 37: nakama.realtime.PartyMatchmakerAdd
	(*PartyMatchmakerRemove)(nil),            // 38: nakama.realtime.PartyMatchmakerRemove
	(*PartyMatchmakerTicket)(nil),            // 39: nakama.realtime.PartyMatchmakerTicket
	(*PartyData)(nil),                        // 40: nakama.realtime.PartyData
	(*PartyDataSend)(nil),                    // 41: nakama.realtime.PartyDataSend
	(*PartyPresenceEvent)(nil),               // 42: nakama.realtime.PartyPresenceEvent
	(*Ping)(nil),                             // 43: nakama.realtime.Ping
	(*Pong)(nil),                             // 44: nakama.realtime.Pong
	(*Status)(nil),                           // 45: nakama.realtime.Status
	(*StatusFollow)(nil),                     // 46: nakama.realtime.StatusFollow
	(*StatusPresenceEvent)(nil),              // 47: nakama.realtime.StatusPresenceEvent
	(*StatusUnfollow)(nil),                   // 48: nakama.realtime.StatusUnfollow
	(*StatusUpdate)(nil),                     // 49: nakama.realtime.StatusUpdate
	(*Stream)(nil),                           // 50: nakama.realtime.Stream
	(*StreamData)(nil),                       // 51: nakama.realtime.StreamData
	(*StreamPresenceEvent)(nil),              // 52: nakama.realtime.StreamPresenceEvent
	(*UserPresence)(nil),                     // 53: nakama.realtime.UserPresence
	nil,                                      // 54: nakama.realtime.Error.ContextEntry
	nil,                                      // 55: nakama.realtime.MatchJoin.MetadataEntry
	nil,                                      // 56: nakama.realtime.MatchmakerAdd.StringPropertiesEntry
	nil,                                      // 57: nakama.realtime.MatchmakerAdd.NumericPropertiesEntry
	nil,                                      // 58: nakama.realtime.MatchmakerMatched_MatchmakerUser.StringPropertiesEntry
	nil,                                      // 59: nakama.realtime.MatchmakerMatched_MatchmakerUser.NumericPropertiesEntry
...
var file_realtime_proto_depIdxs = []int32{
	...
	45,  // 23: nakama.realtime.Envelope.status:type_name -> nakama.realtime.Status
	46,  // 24: nakama.realtime.Envelope.status_follow:type_name -> nakama.realtime.StatusFollow
	47,  // 25: nakama.realtime.Envelope.status_presence_event:type_name -> nakama.realtime.StatusPresenceEvent
	48,  // 26: nakama.realtime.Envelope.status_unfollow:type_name -> nakama.realtime.StatusUnfollow
	49,  // 27: nakama.realtime.Envelope.status_update:type_name -> nakama.realtime.StatusUpdate
	51,  // 28: nakama.realtime.Envelope.stream_data:type_name -> nakama.realtime.StreamData
	52,  // 29: nakama.realtime.Envelope.stream_presence_event:type_name -> nakama.realtime.StreamPresenceEvent
	43,  // 30: nakama.realtime.Envelope.ping:type_name -> nakama.realtime.Ping
	44,  // 31: nakama.realtime.Envelope.pong:type_name -> nakama.realtime.Pong
	...
	28,  // 34: nakama.realtime.Envelope.party_join:type_name -> nakama.realtime.PartyJoin
	29,  // 35: nakama.realtime.Envelope.party_leave:type_name -> nakama.realtime.PartyLeave
	30,  // 36: nakama.realtime.Envelope.party_promote:type_name -> nakama.realtime.PartyPromote
	31,  // 37: nakama.realtime.Envelope.party_leader:type_name -> nakama.realtime.PartyLeader
	32,  // 38: nakama.realtime.Envelope.party_accept:type_name -> nakama.realtime.PartyAccept
	33,  // 39: nakama.realtime.Envelope.party_remove:type_name -> nakama.realtime.PartyRemove
	34,  // 40: nakama.realtime.Envelope.party_close:type_name -> nakama.realtime.PartyClose
	35,  // 41: nakama.realtime.Envelope.party_join_request_list:type_name -> nakama.realtime.PartyJoinRequestList
	36,  // 42: nakama.realtime.Envelope.party_join_request:type_name -> nakama.realtime.PartyJoinRequest
	37,  // 43: nakama.realtime.Envelope.party_matchmaker_add:type_name -> nakama.realtime.PartyMatchmakerAdd
	38,  // 44: nakama.realtime.Envelope.party_matchmaker_remove:type_name -> nakama.realtime.PartyMatchmakerRemove
	39,  // 45: nakama.realtime.Envelope.party_matchmaker_ticket:type_name -> nakama.realtime.PartyMatchmakerTicket
	40,  // 46: nakama.realtime.Envelope.party_data:type_name -> nakama.realtime.PartyData
	41,  // 47: nakama.realtime.Envelope.party_data_send:type_name -> nakama.realtime.PartyDataSend
	42,  // 48: nakama.realtime.Envelope.party_presence_event:type_name -> nakama.realtime.PartyPresenceEvent
	27,  // 49: nakama.realtime.Envelope.party_update:type_name -> nakama.realtime.PartyUpdate
	53,  // 50: nakama.realtime.Channel.presences:type_name -> nakama.realtime.UserPresence
	53,  // 51: nakama.realtime.Channel.self:type_name -> nakama.realtime.UserPresence
	...
	53,  // 58: nakama.realtime.ChannelPresenceEvent.joins:type_name -> nakama.realtime.UserPresence
	53,  // 59: nakama.realtime.ChannelPresenceEvent.leaves:type_name -> nakama.realtime.UserPresence
	54,  // 60: nakama.realtime.Error.context:type_name -> nakama.realtime.Error.ContextEntry
	67,  // 61: nakama.realtime.Match.label:type_name -> google.protobuf.StringValue
	53,  // 62: nakama.realtime.Match.presences:type_name -> nakama.realtime.UserPresence
	53,  // 63: nakama.realtime.Match.self:type_name -> nakama.realtime.UserPresence
	53,  // 64: nakama.realtime.MatchData.presence:type_name -> nakama.realtime.UserPresence
	53,  // 65: nakama.realtime.MatchDataSend.presences:type_name -> nakama.realtime.UserPresence
	55,  // 66: nakama.realtime.MatchJoin.metadata:type_name -> nakama.realtime.MatchJoin.MetadataEntry
	53,  // 67: nakama.realtime.MatchPresenceEvent.joins:type_name -> nakama.realtime.UserPresence
	53,  // 68: nakama.realtime.MatchPresenceEvent.leaves:type_name -> nakama.realtime.UserPresence
	56,  // 69: nakama.realtime.MatchmakerAdd.string_properties:type_name -> nakama.realtime.MatchmakerAdd.StringPropertiesEntry
	57,  // 70: nakama.realtime.MatchmakerAdd.numeric_properties:type_name -> nakama.realtime.MatchmakerAdd.NumericPropertiesEntry
	65,  // 71: nakama.realtime.MatchmakerAdd.count_multiple:type_name -> google.protobuf.Int32Value
	53,  // 72: nakama.realtime.MatchmakerMatched_MatchmakerUser.presence:type_name -> nakama.realtime.UserPresence
	58,  // 73: nakama.realtime.MatchmakerMatched_MatchmakerUser.string_properties:type_name -> nakama.realtime.MatchmakerMatched_MatchmakerUser.StringPropertiesEntry
	59,  // 74: nakama.realtime.MatchmakerMatched_MatchmakerUser.numeric_properties:type_name -> nakama.realtime.MatchmakerMatched_MatchmakerUser.NumericPropertiesEntry
	20,  // 75: nakama.realtime.MatchmakerMatched.users:type_name -> nakama.realtime.MatchmakerMatched_MatchmakerUser
	20,  // 76: nakama.realtime.MatchmakerMatched.self:type_name -> nakama.realtime.MatchmakerMatched_MatchmakerUser
	68,  // 77: nakama.realtime.Notifications.notifications:type_name -> nakama.api.Notification
	53,  // 78: nakama.realtime.Party.self:type_name -> nakama.realtime.UserPresence
	53,  // 79: nakama.realtime.Party.leader:type_name -> nakama.realtime.UserPresence
	53,  // 80: nakama.realtime.Party.presences:type_name -> nakama.realtime.UserPresence
	53,  // 81: nakama.realtime.PartyPromote.presence:type_name -> nakama.realtime.UserPresence
	53,  // 82: nakama.realtime.PartyLeader.presence:type_name -> nakama.realtime.UserPresence
	53,  // 83: nakama.realtime.PartyAccept.presence:type_name -> nakama.realtime.UserPresence
	53,  // 84: nakama.realtime.PartyRemove.presence:type_name -> nakama.realtime.UserPresence
	53,  // 85: nakama.realtime.PartyJoinRequest.presences:type_name -> nakama.realtime.UserPresence
	60,  // 86: nakama.realtime.PartyMatchmakerAdd.string_properties:type_name -> nakama.realtime.PartyMatchmakerAdd.StringPropertiesEntry
	61,  // 87: nakama.realtime.PartyMatchmakerAdd.numeric_properties:type_name -> nakama.realtime.PartyMatchmakerAdd.NumericPropertiesEntry
	65,  // 88: nakama.realtime.PartyMatchmakerAdd.count_multiple:type_name -> google.protobuf.Int32Value
	53,  // 89: nakama.realtime.PartyData.presence:type_name -> nakama.realtime.UserPresence
	53,  // 90: nakama.realtime.PartyPresenceEvent.joins:type_name -> nakama.realtime.UserPresence
	53,  // 91: nakama.realtime.PartyPresenceEvent.leaves:type_name -> nakama.realtime.UserPresence
	53,  // 92: nakama.realtime.Status.presences:type_name -> nakama.realtime.UserPresence
	53,  // 93: nakama.realtime.StatusPresenceEvent.joins:type_name -> nakama.realtime.UserPresence
	53,  // 94: nakama.realtime.StatusPresenceEvent.leaves:type_name -> nakama.realtime.UserPresence
	67,  // 95: nakama.realtime.StatusUpdate.status:type_name -> google.protobuf.StringValue
	50,  // 96: nakama.realtime.StreamData.stream:type_name -> nakama.realtime.Stream
	53,  // 97: nakama.realtime.StreamData.sender:type_name -> nakama.realtime.UserPresence
	50,  // 98: nakama.realtime.StreamPresenceEvent.stream:type_name -> nakama.realtime.Stream
	53,  // 99: nakama.realtime.StreamPresenceEvent.joins:type_name -> nakama.realtime.UserPresence
	53,  // 100: nakama.realtime.StreamPresenceEvent.leaves:type_name -> nakama.realtime.UserPresence
	67,  // 101: nakama.realtime.UserPresence.status:type_name -> google.protobuf.StringValue
...
func file_realtime_proto_init() {
	...
	file_realtime_proto_msgTypes[19].OneofWrappers = []any{
