...
type ValidatedSubscription struct {
	...
	// Raw provider validation response body.
	ProviderResponse string `protobuf:"bytes,10,opt,name=provider_response,json=providerResponse,proto3" json:"provider_response,omitempty"`
	// Raw provider notification body.
	ProviderNotification string `protobuf:"bytes,11,opt,name=provider_notification,json=providerNotification,proto3" json:"provider_notification,omitempty"`
}
