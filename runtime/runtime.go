...
type NakamaModule interface {
	...
	ChannelMessagesList(ctx context.Context, channelId string, limit int, forward bool, cursor string, instant int64) (messages []*api.ChannelMessage, nextCursor string, prevCursor string, err error)
}
